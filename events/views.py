...
def split_date(string_date):
    """"Transforma a data em YYYY-MM-DD em uma tripla de trÊs valores para utilizar na visão de eventos de um determinado dia."""
...
def delete(request, id: int):
    """"Apaga um evento específico, se o evento não existir resultará em erro 404, se algo errado ocorrer retornará a página de erro."""
...
def edit(request):
    """"Edita o comentário de um evento, recebendo os dados enviados pelo formulário, validando e populando em um evento já existente."""
...
def show(request, id: int):
    """"Visualização de um determinado evento e de seus comentários, recebe o 'id' do evento. Caso seja acssado via POST insereum novo comentário."""
    event= get_object_or_404(Event, id=id)
